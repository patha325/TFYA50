...
----------------------*/
Atom::Atom(Vec starting_position, Vec new_prev_acceleration, float start_cutoff, int unit_cells_x, int unit_cells_y, int unit_cells_z, float new_sigma, float new_epsilon, float new_mass, float new_time_step){
...
float Atom::calculate_temperature(float E_kin){
	...
	float k_b = 8.617342e-5f; //[eV][K]^{-1} f:et på slutet är bara till för att kompilatorna ska fatta att det är en float, annars blir det en varning.
