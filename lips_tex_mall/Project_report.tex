...
\subsection{Graphics}
\label{sec:graphics}
The exists a \texttt{Matlab} program beside from the main C++ program that is used to plot graphs for all the data which is specifies in \ref{sec:data_output}.
